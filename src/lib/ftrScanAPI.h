...
Copyright (c) 2003-2018 Futronic Technology Company Ltd. All rights reserved.
...
#if defined(__GNUG__) && defined(__BYTE_ORDER__)
#if __BYTE_ORDER__ != __ORDER_LITTLE_ENDIAN__
#error This code can be compiled only for Little-Endian arch
#endif
#endif
...
#define FTR_OPTIONS_ROLL_NICE_PREVIEW                   0x00400000
...
#define FTR_GLOBAL_FORCE_RESET_DEVICE                   0x00000009
#define FTR_GLOBAL_ALFD_INITSTREAM                      0x0000000A /* for Android only */
...
#define FTR_ERROR_OK                                    0
#define FTR_ERROR_NO_ERROR                              FTR_ERROR_OK
...
/* FTR_DEVICE_USB_1_1 is deprecated */
...
#define FTR_DEVICE_USB_2_0_TYPE_26EU                    20
#define FTR_DEVICE_USB_2_0_TYPE_84D                     21
#define FTR_DEVICE_USB_2_0_TYPE_26H                     22
#define FTR_DEVICE_USB_2_0_TYPE_80H_LFD_ONLY            23
#define FTR_DEVICE_USB_3_0_TYPE_64                      24
#define FTR_DEVICE_USB_2_0_TYPE_VS80                    25
...
byDeviceCompatibility:
       ...
       24 - USB 3.0 device (FS64 compatible)
       25 - USB 2.0 device (Finger Vein scanner - JX-H22 sensor)
...
#define FTR_PROPERTY_LFD_HW_2_CALCULATED_DATA               6
#define FTR_PROPERTY_LFD_HW_2_PARAM                         7
#define FTR_PROPERTY_LFD_D_HW_2_CALCULATED_DATA             8
...
#define FTR_PROPERTY_FIRMWARE_TYPE                          14
#define FTR_PROPERTY_LFD_HW_2_SPOOF_DETECT_LEVEL            15
#define FTR_PROPERTY_LFD_ALFD_CALCULATED_DATA               16
...
typedef struct FTR_PACKED _FTRSCAN_PROPERTY_LFD_HW_2_DATA
{
    FTR_DWORD                           dwScore;
} FTRSCAN_PROPERTY_LFD_HW_2_DATA, *PFTRSCAN_PROPERTY_LFD_HW_2_DATA;

typedef struct FTR_PACKED _FTRSCAN_PROPERTY_LFD_HW_2_PARAM
{
    FTR_DWORD                           dwScore;
} FTRSCAN_PROPERTY_LFD_HW_2_PARAM, *PFTRSCAN_PROPERTY_LFD_HW_2_PARAM;
...
typedef struct FTR_PACKED _FTRSCAN_PROPERTY_LFD_HW_2_SPOOF_DETECT_LEVEL
{
    FTR_DWORD                           dwLevel;
} FTRSCAN_PROPERTY_LFD_HW_2_SPOOF_DETECT_LEVEL, *PFTRSCAN_PROPERTY_LFD_HW_2_SPOOF_DETECT_LEVEL;

typedef struct FTR_PACKED _FTRSCAN_PROPERTY_LFD_ALFD_DATA
{
    double                              dblCalcRes [10];
} FTRSCAN_PROPERTY_LFD_ALFD_DATA, *PFTRSCAN_PROPERTY_LFD_ALFD_DATA;

#define FTR_PROP_FIRMWARE_TYPE_BLACKFIN                 1
#define FTR_PROP_FIRMWARE_TYPE_FS80                     2

typedef struct FTR_PACKED _FTRSCAN_PROPERTY_FIRMWARE_TYPE
{
    FTR_BYTE                            byFirmwareType;
} FTRSCAN_PROPERTY_FIRMWARE_TYPE, *PFTRSCAN_PROPERTY_FIRMWARE_TYPE;
...
#define FTR_LFD_MODE_HW_2                               0x00000004
#define FTR_LFD_MODE_ALFD                               0x00000008

#define FTR_LFD_MODE_SW_1_MAX_STRENGTH                  9

#define FTR_LFD_MODE_HW_2_MOST_LIKELY_TO_BE_FAKE        5

#define FTR_LFD_LEVEL_1                                 FTR_LFD_MODE_HW
#define FTR_LFD_LEVEL_2                                 (FTR_LFD_MODE_HW | FTR_LFD_MODE_SW_1)
#define FTR_LFD_LEVEL_3                                 (FTR_LFD_MODE_HW | FTR_LFD_MODE_HW_2)
#define FTR_LFD_LEVEL_MAX                               (FTR_LFD_MODE_HW | FTR_LFD_MODE_SW_1 | FTR_LFD_MODE_HW_2)

#define FTR_LFD_HW_2_SPOOF_DETECT_LEVEL_LOW             0
#define FTR_LFD_HW_2_SPOOF_DETECT_LEVEL_DEFAULT         1
#define FTR_LFD_HW_2_SPOOF_DETECT_LEVEL_HIGH            2

#define FTR_LFD_HW_2_SPOOF_DETECT_LEVEL_MAX             FTR_LFD_HW_2_SPOOF_DETECT_LEVEL_HIGH
...
#define FTR_ALFD_INIT_CTX_VERSION_1 (1)
...
typedef struct __ALFD_INIT_ANDROID_CTX
{
    FTR_DWORD ctx_version;
    jobject   stream1;
    jobject   stream2;
} ALFD_INIT_ANDROID_CTX, *PALFD_INIT_ANDROID_CTX;
...
#define FTR_DEVICEIOTRANSFER_FLAGS_FS80_FKO             0x0001
...
#define FTR_LOCK_INTERFACE_SIGNATURE                    0x4C49

#define FTR_LOCK_INTERFACE_LOCK                         0x0010
#define FTR_LOCK_INTERFACE_UNLOCK                       0x0020

typedef struct FTR_PACKED _FTR_LOCK_INTERFACE
{
    FTR_WORD                            wSignature;
    FTR_WORD                            wLock;
} FTR_LOCK_INTERFACE, *PFTR_LOCK_INTERFACE;
...
typedef FTR_BOOL(FTR_CALLBACK  *PFTRSIMDEVICEDATAEXCHANGEEX )(FTR_PVOID pHandle, int nPortionLength, FTR_PVOID pOutData, int nOutDataLen, FTR_PVOID pInData, int nInDataLen, FTR_DWORD flags);
...
typedef struct __FTRSCAN_SIM_CONTEXT2
{
    FTRSCAN_SIM_CONTEXT         baseContext1;
    PFTRSIMDEVICEDATAEXCHANGEEX pfDeviceDataExchangeEx;
} FTRSCAN_SIM_CONTEXT2, *PFTRSCAN_SIM_CONTEXT2;
...
FTR_API_PREFIX FTR_BOOL FTR_API ftrInternalDeviceLock( FTRHANDLE ftrHandle, PFTR_LOCK_INTERFACE pLockInterface );
...
FTR_API_PREFIX FTR_DWORD FTR_API ftrScanGetErrorMessage( FTR_DWORD dwErrorCode, char *pMessageBuffer, FTR_DWORD *pdwBufferSize, FTR_DWORD *pReserved );

FTR_API_PREFIX FTR_BOOL ftrScanGetDeviceNameOnInterface( FTR_DWORD nInterface, char *pBuffer, FTR_DWORD nBufferLenegth );
